...
//		setBounds(100, 100, 719, 476);
		...
		cboAccNo.setBounds(397, 42, 124, 27);
		panel.add(cboAccNo);
...
//	            	fillAccountForSelected();
		...
		btnSearch.setBounds(297, 83, 87, 27);
		panel.add(btnSearch);
		...
		lblCName.setBounds(10, 46, 90, 19);
		panel.add(lblCName);
		
		textField = new JTextField();
		textField.setBounds(10, 84, 96, 25);
		panel.add(textField);
		textField.setColumns(10);
		
		txtAccType = new JTextField();
		txtAccType.setColumns(10);
		txtAccType.setBounds(135, 85, 96, 25);
		panel.add(txtAccType);
		
		lblAccType = new JLabel("Account Type");
		lblAccType.setBounds(135, 47, 90, 19);
