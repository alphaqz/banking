...
//			                    txtprice.requestFocus();
				...
				}
				{
					...
					lblforDepositID.setBounds(87, 25, 197, 22);
			...
			tblpurchase.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(MouseEvent e) {
					...
					selectedRow = r;
					lblforDepositID.setText(tblpurchase.getValueAt(r, 0).toString());
					txtamount.setText(tblpurchase.getValueAt(r, 1).toString());
	                cboAccountID.setSelectedItem(tblpurchase.getValueAt(r, 2));
	                cboStaffID.setSelectedItem(tblpurchase.getValueAt(r, 3));
	                lblForDate.setText(tblpurchase.getValueAt(r, 4).toString());
				}
			});
